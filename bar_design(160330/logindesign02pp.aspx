<%@ Page Language="C#" AutoEventWireup="true" CodeFile="logindesign02pp.aspx.cs" Inherits="logindesign02pp" %>
...
<body>
    <form id="form1" runat="server">
        <div class="vid-container">
            <div class="bgset"></div>
            <img style="margin-left: 25%; margin-top: 90px" src="logindesign02style/logo_mcpoly.png" />
            ...
            <div class="inner-container">
                <div class="box">
                    ...
                    <asp:Button ID="LoginButton" CssClass="button01" runat="server" Text="Login / Post Job"  />
                    <%--<button class="button02">Register</button>--%>
                    <asp:Button ID="RegisterButton" CssClass="button02" runat="server" Text="Not a member? Sign Up"  />
