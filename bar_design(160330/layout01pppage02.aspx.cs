...
public partial class layout01pppage02 : BasePage
{
    ...
    */
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string insertQuery = "insert into CareerForm(IsApproval,career,Industry,OrganiztionName1,BusinessNature,JobDescription,Salary,SalaryHour,SalaryDay,SalaryMonth,Requirements,ApplicationEndDate,ApplicationStartDate,ApplicationLetter,Resume,IDCopy,Transcript,DrivingLicense,DocsOthers,ApplicationPostTo,ApplicationEmail,ApplicationPhone,ApplicationOthers,ContactPersonName,ContactPersonType1,ContactPersonType2,ContactPersonPhone,ContactPersonEmail,Professional_Competence_level,Leadership_level,Communication_level,Creativity_level,Initiative_level,Self_Development_level,Social_Responsibility_level,Language_level,IT_Application_level,Views,CompanyID,phototype) values (@IsApproval,@career,@Industry,@OrganiztionName1,@BusinessNature,@JobDescription,@Salary,@SalaryHour,@SalaryDay,@SalaryMonth,@Requirements,@ApplicationEndDate,@ApplicationStartDate,@ApplicationLetter,@Resume,@IDCopy,@Transcript,@DrivingLicense,@DocsOthers,@ApplicationPostTo,@ApplicationEmail,@ApplicationPhone,@ApplicationOthers,@ContactPersonName,@ContactPersonType1,@ContactPersonType2,@ContactPersonPhone,@ContactPersonEmail,@Professional_Competence_level,@Leadership_level,@Communication_level,@Creativity_level,@Initiative_level,@Self_Development_level,@Social_Responsibility_level,@Language_level,@IT_Application_level,@Views,@CompanyID,@phototype)";
        ...
        Response.Write("<script>alert('You are sumbit the page !'); window.location.href='layout01pppage02.aspx'; </script>");
        ...
        if (FileUpload1.HasFile)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("insert into CareerForm (UpFileName,UpFile,UpFileType,Industry,career,IsApproval,VacancyNumber,OrganiztionName1,BusinessNature,Salary,Views,Professional_Competence_level,Leadership_level,Communication_level,Creativity_level,Initiative_level,Self_Development_level,Social_Responsibility_level,Language_level,IT_Application_level,CompanyID,phototype)" + " values (@UpFileName,@UpFile,@UpFileType,@Industry,@career,@IsApproval,@VacancyNumber,@OrganiztionName1,@BusinessNature,@Salary,@Views,@Professional_Competence_level,@Leadership_level,@Communication_level,@Creativity_level,@Initiative_level,@Self_Development_level,@Social_Responsibility_level,@Language_level,@IT_Application_level,@CompanyID,@phototype)", conn);
