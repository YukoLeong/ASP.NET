...
public partial class layout01ppstudent01 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        SqlCommand sqlcode = new SqlCommand("select * from CareerForm where CompanyID is not null and canpost=1 ORDER BY careerformid desc", conn);
    ...
    protected void OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("layout01ppstudent03.aspx");
