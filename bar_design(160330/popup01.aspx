<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup01.aspx.cs" Inherits="popup01" %>
...
<head runat="server">
    ...
    <%--popup website--%>
    <%--http://dimsemenov.com/plugins/magnific-popup/     but can not get the demo version       --%>  
    ...
    <form id="form1" runat="server">
        ...
        <span class="code-function">function()</span> {
            alert(<span class="code-string">'Callback fired'</span>);
                ...
                <li>
                    ...
                    <span class="button small pop2" data-bpopup='{"contentContainer":".content","loadUrl":"popup01style/test.html"}'>Pop it up</span>
                    <span class="example">
        ...
        $(<span class="code-string">'element_to_pop_up'</span>).bPopup({
            ...
            loadUrl: <span class="code-string">'test.html'</span><span class="code-comment"> //Uses jQuery.load()</span>
                ...
                <li>
                    <span class="button small pop2" data-bpopup='{"content":"image","contentContainer":".content","loadUrl":"popup01style/images/dog.jpg"}'>Pop it up</span>
                    <span class="example">
