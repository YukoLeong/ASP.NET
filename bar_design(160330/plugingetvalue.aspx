<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plugingetvalue.aspx.cs" Inherits="plugingetvalue" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            //$('#example-a').barrating('set',4);
            //alert($("#example-a").val());


            $('#example-a').change(function () {
                var aaa = $("#example-a").val();
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="TextBox1" runat="server">7</asp:TextBox>
