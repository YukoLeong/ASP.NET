<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Countdown03.aspx.cs" Inherits="Countdown03" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                clock = $('.clock').FlipClock({
                    ...
                    callbacks: {
                        stop: function () {
                            window.open('Countdown04.aspx', '_self');
        ...
        <img src="countdownstyle/2_333.jpg" />
    </form>
</body>
</html>
