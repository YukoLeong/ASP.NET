<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buttonhover01.aspx.cs" Inherits="buttonhover01" %>
...
<head runat="server">
    ...
    <link href="buttonhover01style/demo-page.css" rel="stylesheet" media="all" />
    <link href="buttonhover01style/hover.css" rel="stylesheet" media="all" />
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet" media="all" />

<%--    
    button hover site
    http://www.thepetedesign.com/demos/jquery_wheelmenu_demo.html      jQuery Wheel Menu
    ...
    <form id="form1" runat="server">
        ...
        <div class="footer">
            <div class="about">
                ...
                <p>
                    Hover.css is open source, and made available under a <a href="http://www.opensource.org/licenses/mit-license.php">MIT License</a>. Distribute, use as-is, or modify to your liking in personal and commercial projects. Please retain the original readme and license files.
            ...
            <div class="author">
                ...
                <p class="follow">
                    <a href="https://twitter.com/IanLunn" class="twitter-follow-button" data-show-count="false" data-dnt="true" data-size="large">Follow @IanLunn</a> for tweets, opinions,  and links<br />
                    relating to CSS3, HTML5, and JavaScript
                </p>
