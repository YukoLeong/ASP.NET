<%@ Page Language="C#" AutoEventWireup="true" CodeFile="responsive_gallery01.aspx.cs" Inherits="responsive_gallery01" %>
...
<head runat="server">
		...
		<link rel="stylesheet" type="text/css" href="responsive_gallery01style/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="responsive_gallery01style/css/demo.css" />
		<link rel="stylesheet" type="text/css" href="responsive_gallery01style/css/component.css" />
		<script src="responsive_gallery01style/js/modernizr.min.js"></script>
    ...
    <form id="form1" runat="server">
		<div class="container">
			...
			<section id="photostack-1" class="photostack photostack-start">
				<div>
					<figure>
						<a href="http://goo.gl/Qw3ND4" class="photostack-img"><img src="responsive_gallery01style/img/1.jpg" alt="img01"/></a>
						<figcaption>
							<h2 class="photostack-title">Serenity Beach</h2>
						</figcaption>
					</figure>
					<figure>
						<a href="http://goo.gl/fhwlSP" class="photostack-img"><img src="responsive_gallery01style/img/2.jpg" alt="img02"/></a>
						<figcaption>
							<h2 class="photostack-title">Happy Days</h2>
						</figcaption>
					</figure>
					<figure>
						<a href="http://goo.gl/Jmvr4u" class="photostack-img"><img src="responsive_gallery01style/img/3.jpg" alt="img03"/></a>
						<figcaption>
							<h2 class="photostack-title">Beautywood</h2>
						</figcaption>
					</figure>
					<figure>
						<a href="http://goo.gl/49lN3k" class="photostack-img"><img src="responsive_gallery01style/img/4.jpg" alt="img04"/></a>
						<figcaption>
							<h2 class="photostack-title">Heaven of time</h2>
						</figcaption>
					</figure>
					<figure>
						<a href="http://goo.gl/NJ1Dhf" class="photostack-img"><img src="responsive_gallery01style/img/5.jpg" alt="img05"/></a>
						<figcaption>
							<h2 class="photostack-title">Speed Racer</h2>
						</figcaption>
					</figure>
					<figure>
						<a href="http://goo.gl/Ms7VDl" class="photostack-img"><img src="responsive_gallery01style/img/6.jpg" alt="img06"/></a>
						<figcaption>
							<h2 class="photostack-title">Forever this</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/7.jpg" alt="img07"/></a>
						<figcaption>
							<h2 class="photostack-title">Lovely Green</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/8.jpg" alt="img08"/></a>
						<figcaption>
							<h2 class="photostack-title">Wonderful</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/9.jpg" alt="img09"/></a>
						<figcaption>
							<h2 class="photostack-title">Love Addict</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/10.jpg" alt="img10"/></a>
						<figcaption>
							<h2 class="photostack-title">Friendship</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/11.jpg" alt="img11"/></a>
						<figcaption>
							<h2 class="photostack-title">White Nights</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/12.jpg" alt="img12"/></a>
						<figcaption>
							<h2 class="photostack-title">Serendipity</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/13.jpg" alt="img13"/></a>
						<figcaption>
							<h2 class="photostack-title">Pure Soul</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/14.jpg" alt="img14"/></a>
						<figcaption>
							<h2 class="photostack-title">Winds of Peace</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/15.jpg" alt="img15"/></a>
						<figcaption>
							<h2 class="photostack-title">Shades of blue</h2>
						</figcaption>
					</figure>
					<figure data-dummy>
						<a href="#" class="photostack-img"><img src="responsive_gallery01style/img/16.jpg" alt="img16"/></a>
						<figcaption>
			...
			<section class="related">
				...
				<a href="http://tympanus.net/Development/ElasticStack/">
					<img src="responsive_gallery01style/img/ElastiStackMain-300x162.jpg" />
					<h3>Elastic Stack</h3>
				</a>
				<a href="http://tympanus.net/Tutorials/ThumbnailGridExpandingPreview/">
					<img src="responsive_gallery01style/img/ThumbnailGridExpandingPreview-300x162.jpg" />
					<h3>Expanding Thumbnail Grid</h3>
				</a>

			</section>
		</div><!-- /container -->
		<script src="responsive_gallery01style/js/classie.js"></script>
		<script src="responsive_gallery01style/js/photostack.js"></script>
		<script>
		...
		<script src="responsive_gallery01style/js/demoad.js"></script>
    </form>
</body>
</html>
