<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ajax01.aspx.cs" Inherits="ajax01" %>
...
<head runat="server">
    ...
    <%--https://www.youtube.com/watch?v=0P2hT2-C4yo--%>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#button01").click(function () {
                $.ajax({
                    type: "POST",
                    url: "ajax01WebService.asmx/test01",
                    data: {},
            ...
            $("#button02").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax01WebService.asmx/test02",
