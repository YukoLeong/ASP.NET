...
/// <summary>
/// Summary description for layout01ppmanage02WebService
/// </summary>
...
public class layout01ppmanage02WebService : System.Web.Services.WebService {
    ...
    public void SyncData(string data, string careerformid)
    {
        if (data != "" && careerformid!="")
        {
            ...
            sb.Append("UPDATE CareerForm SET canpost=@data where CareerFormID=@CareerFormID");
