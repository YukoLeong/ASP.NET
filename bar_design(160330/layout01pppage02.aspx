<%@ Page Language="C#" AutoEventWireup="true" CodeFile="layout01pppage02.aspx.cs" Inherits="layout01pppage02" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="sliderbar01style2/examples.css" />
    ...
    <script src="sliderbar01style2/jquery.barrating.js"></script>
    <script src="sliderbar01style2/examples.js"></script>

    <!-- Add IntroJs styles -->
    <link href="inrojs01style/changeintrojs.css" rel="stylesheet" />
    ...
    <style type="text/css">
        ...
        #logopart2 {
            background: url(layout50style2/jobsrecruitment.png) no-repeat top center;
            width: 56%;
            height: 94px;
            margin-top: 20px;
            float: left;
                ...
                <div class="divborder">
                    ...
                    <div style="width: 930px; margin: auto">
                        ...
                        <div id="content">
                            ...
                            <asp:ImageButton ID="BackButton" runat="server" onmouseover="this.src='layout01pppage01style/back01_hover.png'" onmouseout="this.src='layout01pppage01style/back01.png'" ImageUrl="~/layout01pppage01style/back01.png" OnClick="BackButton_Click" Style="width: 105px" CausesValidation="false" />
                        ...
                        <table class="style3">
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <asp:ImageButton ID="SubmitButton2" runat="server" onmouseover="this.src='layout01pppage01style/submit01_hover.png'" onmouseout="this.src='layout01pppage01style/submit01.png'" ImageUrl="~/layout01pppage01style/submit01.png" OnClick="Button1_Click" Style="width: 130px" />
