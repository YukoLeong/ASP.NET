<%@ Page Language="C#" AutoEventWireup="true" CodeFile="layout01pppage01.aspx.cs" Inherits="layout01pppage01" %>
...
<head runat="server">
    <title></title>
    <script src="layout01pppage01style/jquery.js" type="text/javascript"></script>
    <script src="layout01pppage01style/jquery-ui.js" type="text/javascript"></script>
    <link href="layout01pppage01style/jquery-ui.css" rel="stylesheet" />
    <script src="layout01pppage01style/jquery-1.11.2.min.js" type="text/javascript"></script>
...
<%--            <asp:Button ID="HomeButton" runat="server" Text="Home" CssClass="blue" Width="100px"
    ...
    <div style="text-align:center;margin-top:5px;padding-bottom:3px;width:1554px">
               <asp:ImageButton ID="ImageButton2" runat="server" onmouseover="this.src='layout01pppage01style/homeblue_hover.png'" onmouseout="this.src='layout01pppage01style/homeblue.png'" ImageUrl="layout01pppage01style/homeblue.png" OnClick="ImageButton2_Click" CausesValidation="False" /> 
    </div>
