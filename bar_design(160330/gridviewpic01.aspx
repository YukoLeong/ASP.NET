<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gridviewpic01.aspx.cs" Inherits="gridviewpic01" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ForeColor="#333333" GridLines="None" Width="928px" ShowFooter="True">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Photo">
                                    <ItemTemplate>
                                        <asp:Image ID="gridviewimage01" runat="server" ImageUrl='<%# Bind("image") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="col2" SortExpression="col2">
                                    <ItemTemplate>
                                        <asp:Image ID="gridviewimage02" runat="server" ImageUrl='<%# Bind("image") %>' />
                                        <asp:Label ID="col2" runat="server" Text='<%#Eval("col2")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="JobType" SortExpression="image">
                                    <ItemTemplate>
                                        <asp:Label ID="image" runat="server" Text='<%#Eval("image")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:ImageField HeaderText="image" ControlStyle-Height="16px" ControlStyle-Width="16px" DataImageUrlField="image"></asp:ImageField>
                            </Columns>
