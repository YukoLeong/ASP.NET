<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherSubjects.aspx.cs" Inherits="YearTutor_TeacherSubjects" %>
...
<body background="../images/bg-blue.jpg">
    ...
    <div id="content">
        ...
        <asp:Label ID="Label1" ÏD="txt_title" runat="server" Text="Instructor Subjects" class="title"/>
         <asp:Button ID="homeButton" runat="server" Text="Home" Style="width: 100px;margin-left:232px;"  CssClass="blue"
       ...
       <asp:Label ID="txt_msg" runat="server" Text="Please select subject:" style="color:black;font-size:12pt;"/>
        <table>
           ...
           <td><asp:TextBox ID="txt_subjectName" runat="server" Enabled="false" style="width:350px;" ></asp:TextBox></td>
           </tr>
        </table>
        <br />
        <br />
