...
public partial class MPICP_Register : System.Web.UI.Page
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (FileUpload1.HasFile)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                string insertQuery = "insert into CareerCompanyRegist(UpFileName,UpFile,UpFileType,AccountName,Password,Email,Organize,Organize_en,Address,CompanyNum,Companyppl,Department,Phone,Allow,ts) values (@UpFileName,@UpFile,@UpFileType,@AccountName,@Password,@Email,@Organize,@Organize_en,@Address,@CompanyNum,@Companyppl,@Department,@Phone,@Allow,GETDATE())";
                    ...
                    else
                    {
                        ...
                        string insertQuery = "insert into CareerCompanyRegist(AccountName,Password,Email,Organize,Organize_en,Address,CompanyNum,Companyppl,Department,Phone,Allow,ts) values (@AccountName,@Password,@Email,@Organize,@Organize_en,@Address,@CompanyNum,@Companyppl,@Department,@Phone,@Allow,GETDATE())";
                    SqlCommand com2 = new SqlCommand(insertQuery, conn);
                    com2.Parameters.AddWithValue("@AccountName", TextBoxID.Text);
                    com2.Parameters.AddWithValue("@Password", EncryptPassword(TextBoxPassword1.Text));
                    com2.Parameters.AddWithValue("@Email", TextBoxEmail1.Text);
