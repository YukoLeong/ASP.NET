...
public partial class MPICP_Management_Edit : System.Web.UI.Page
{
    ...
    protected void UpdateButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        cmd5.ExecuteNonQuery();
        Response.Write("<script>alert('Update success !'); window.location.href='Management_Edit.aspx'; </script>");
