<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Management_Edit.aspx.cs" Inherits="MPICP_Management_Edit" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #logopart2 {
            background: url(iamges/jobsmanagement.png) no-repeat top center;
            width: 56%;
            height: 94px;
            margin-top: 20px;
            float: left;
