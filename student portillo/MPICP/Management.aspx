<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Management.aspx.cs" Inherits="MPICP_Management" %>
            ...
            <div id="middle_wrap">
                <div class="divborder">
                    ...
                    <div style="width: 930px; height: 650px; margin: auto">
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" GridLines="None" Width="928px" ShowFooter="True" OnSelectedIndexChanged="OnSelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="CareerFormID">
                            <%--OnSelectedIndexChanged="OnSelectedIndexChanged" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true"--%>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                         <asp:LinkButton ID="LinkButton1" CommandName="Select" ButtonType="Link" runat="server" Visible='<%# (Eval("checked").ToString()=="1") ? true: false %>' >View</asp:LinkButton>
										 <asp:LinkButton ID="LinkButton2" CommandName="Select" ButtonType="Link" runat="server" Visible='<%# (Eval("checked").ToString()=="0") ? true: false %>' >Edit</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>


                                <%--<asp:ButtonField Text="Edit" CommandName="Select" ButtonType="Link" />--%>
                                <%--<asp:ButtonField Text="Modify" CommandName="Select" ButtonType="Link" />--%>
