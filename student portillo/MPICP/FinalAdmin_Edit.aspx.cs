...
public partial class MPICP_FinalAdmin_Edit : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("FinalAdmin.aspx");
    }
    ...
    protected void UpdateButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        cmd5.ExecuteNonQuery();
        Response.Write("<script>alert('Update success !'); window.location.href='FinalAdmin_Edit.aspx'; </script>");
