...
public partial class MPICP_Recruitment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                Response.Write("<script>alert('Please Log In !'); window.location.href='/MPICP/home.aspx'; </script>");
                return;
            }
            ...
            RecruitWayButton.Visible = false;
    ...
    */
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        conn2.Open();
        //string insertQuery = "insert into CareerForm(IsApproval,career,Industry,VacancyNumber,Fulltime,Parttime,OrganiztionName1,BusinessNature,JobDescription,Salary,SalaryHour,SalaryDay,SalaryMonth,Requirements,ApplicationEndDate,ApplicationStartDate,ApplicationLetter,Resume,IDCopy,Transcript,DrivingLicense,DocsOthers,ApplicationPostTo,ApplicationEmail,ApplicationPhone,ApplicationOthers,ContactPersonName,ContactPersonType1,ContactPersonType2,ContactPersonPhone,ContactPersonEmail,Professional_Competence_level,Leadership_level,Communication_level,Creativity_level,Initiative_level,Self_Development_level,Social_Responsibility_level,Language_level,IT_Application_level,Views) values (@IsApproval,@career,@Industry,@VacancyNumber,@Fulltime,@Parttime,@OrganiztionName1,@BusinessNature,@JobDescription,@Salary,@SalaryHour,@SalaryDay,@SalaryMonth,@Requirements,@ApplicationEndDate,@ApplicationStartDate,@ApplicationLetter,@Resume,@IDCopy,@Transcript,@DrivingLicense,@DocsOthers,@ApplicationPostTo,@ApplicationEmail,@ApplicationPhone,@ApplicationOthers,@ContactPersonName,@ContactPersonType1,@ContactPersonType2,@ContactPersonPhone,@ContactPersonEmail,@Professional_Competence_level,@Leadership_level,@Communication_level,@Creativity_level,@Initiative_level,@Self_Development_level,@Social_Responsibility_level,@Language_level,@IT_Application_level,@Views)";
        string insertQuery = "insert into CareerForm(IsApproval,career,career_en,Industry,BusinessNature,JobDescription,Salary,SalaryHour,SalaryDay,SalaryMonth,Requirements,ApplicationEndDate,ApplicationStartDate,ApplicationLetter,Resume,IDCopy,Transcript,DrivingLicense,DocsOthers,ApplicationPostTo,ApplicationEmail,ApplicationPhone,ApplicationOthers,ContactPersonName,ContactPersonType1,ContactPersonType2,ContactPersonPhone,ContactPersonEmail,Professional_Competence_level,Leadership_level,Communication_level,Creativity_level,Initiative_level,Self_Development_level,Social_Responsibility_level,Language_level,IT_Application_level,Views,CompanyID,phototype,phototype2,checked,canpost,ts) values (@IsApproval,@career,@career_en,@Industry,@BusinessNature,@JobDescription,@Salary,@SalaryHour,@SalaryDay,@SalaryMonth,@Requirements,@ApplicationEndDate,@ApplicationStartDate,@ApplicationLetter,@Resume,@IDCopy,@Transcript,@DrivingLicense,@DocsOthers,@ApplicationPostTo,@ApplicationEmail,@ApplicationPhone,@ApplicationOthers,@ContactPersonName,@ContactPersonType1,@ContactPersonType2,@ContactPersonPhone,@ContactPersonEmail,@Professional_Competence_level,@Leadership_level,@Communication_level,@Creativity_level,@Initiative_level,@Self_Development_level,@Social_Responsibility_level,@Language_level,@IT_Application_level,@Views,@CompanyID,@phototype,@phototype2,@checked,@canpost,GETDATE())";


        SqlCommand com2 = new SqlCommand(insertQuery, conn2);
        com2.Parameters.AddWithValue("@career", TextBox1.Text);
        com2.Parameters.AddWithValue("@career_en", TextBox2.Text);
        ...
        com2.Parameters.AddWithValue("@VacancyNumber", "1");
        com2.Parameters.AddWithValue("@Fulltime", "0");
        com2.Parameters.AddWithValue("@Parttime", "0");
        ...
        com2.Parameters.AddWithValue("@Professional_Competence_level", abilitytemp1.Text);
        com2.Parameters.AddWithValue("@Leadership_level", abilitytemp2.Text);
        com2.Parameters.AddWithValue("@Communication_level", abilitytemp3.Text);
        com2.Parameters.AddWithValue("@Creativity_level", abilitytemp4.Text);
        com2.Parameters.AddWithValue("@Initiative_level", abilitytemp5.Text);
        com2.Parameters.AddWithValue("@Self_Development_level", abilitytemp6.Text);
        com2.Parameters.AddWithValue("@Social_Responsibility_level", abilitytemp7.Text);
        com2.Parameters.AddWithValue("@Language_level", abilitytemp8.Text);
        com2.Parameters.AddWithValue("@IT_Application_level", abilitytemp9.Text);
        ...
        com2.Parameters.AddWithValue("@CompanyID", Session["CompanyID"]);
        com2.Parameters.AddWithValue("@phototype", "layout01pppage01style/doc16.png");
        com2.Parameters.AddWithValue("@phototype2", "images/doc16.png");
        com2.Parameters.AddWithValue("@checked", "0");
        com2.Parameters.AddWithValue("@canpost", "0");
        ...
        Response.Write("<script>alert('You are sumbit the page !'); window.location.href='Recruitment.aspx'; </script>");
        ...
        if (FileUpload1.HasFile)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("insert into CareerForm (UpFileName,UpFile,UpFileType,Industry,career,IsApproval,VacancyNumber,OrganiztionName1,BusinessNature,Salary,Views,Professional_Competence_level,Leadership_level,Communication_level,Creativity_level,Initiative_level,Self_Development_level,Social_Responsibility_level,Language_level,IT_Application_level,CompanyID,phototype,phototype2,checked,canpost,ts)" + " values (@UpFileName,@UpFile,@UpFileType,@Industry,@career,@IsApproval,@VacancyNumber,@OrganiztionName1,@BusinessNature,@Salary,@Views,@Professional_Competence_level,@Leadership_level,@Communication_level,@Creativity_level,@Initiative_level,@Self_Development_level,@Social_Responsibility_level,@Language_level,@IT_Application_level,@CompanyID,@phototype,@phototype2,@checked,@canpost,GETDATE())", conn);
                    ...
                    cmd.Parameters.AddWithValue("@Professional_Competence_level", "3");
                    cmd.Parameters.AddWithValue("@Leadership_level", "3");
                    cmd.Parameters.AddWithValue("@Communication_level", "3");
                    cmd.Parameters.AddWithValue("@Creativity_level", "3");
                    cmd.Parameters.AddWithValue("@Initiative_level", "3");
                    cmd.Parameters.AddWithValue("@Self_Development_level", "3");
                    cmd.Parameters.AddWithValue("@Social_Responsibility_level", "3");
                    cmd.Parameters.AddWithValue("@Language_level", "3");
                    cmd.Parameters.AddWithValue("@IT_Application_level", "3");
                    cmd.Parameters.AddWithValue("@CompanyID", Session["CompanyID"]);
                    cmd.Parameters.AddWithValue("@phototype", "layout01pppage01style/pdf16.png");
                    cmd.Parameters.AddWithValue("@phototype2", "images/pdf16.png");
                    cmd.Parameters.AddWithValue("@checked", "0");
                    cmd.Parameters.AddWithValue("@canpost", "0");
