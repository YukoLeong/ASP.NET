<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="MPICP_Register" %>
                ...
                <div class="divborder">
                    ...
                    <div style="width: 930px; margin: auto">
                        ...
                        <div id="part3" class="form-group">
                            <label for="label3" class="col-sm-3 control-label" style="padding-top: 8px">上傳商業登記副本 Commericial Registration Copy</label>
                            <div class="col-sm-9" style="padding-top: 25px; padding-bottom: 2px">
