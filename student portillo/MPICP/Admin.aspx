<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="MPICP_Admin" %>
...
<%--                        <asp:ImageButton ID="BackButton" runat="server" onmouseover="this.src='images/back01_hover.png'" onmouseout="this.src='images/back01.png'" ImageUrl="images/back01.png" OnClick="BackButton_Click" Style="width: 105px" />
                        ...
                        <br />--%>
                        <p>Jobs Management(Admin)</p>
                        <br />
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" GridLines="None" Width="928px"  OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged" ShowFooter="True">
                            <%--PageSize="15" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true"--%>

                            <Columns>
                                <asp:TemplateField HeaderText="ID" SortExpression="CareerFormID" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:BoundField HeaderText="Approved" DataField="canpost" />
 ...
 <%--                               <asp:TemplateField HeaderText="Posted" SortExpression="canpost">
                                ...
                                <asp:TemplateField HeaderText="Approval Date" SortExpression="Permit">
                                    <ItemTemplate>
                                ...
                                <asp:ButtonField Text="Check" CommandName="Select"/>
