<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CurriculumVitae.aspx.vb" Inherits="ep.CurriculumVitae" %>
...
<body background="../images/message_board_background.gif">
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" 
            SelectMethod="GetPersonalInfoDataBy" 
            TypeName="ep.EPDataSetTableAdapters.personal_infoTableAdapter">
            <InsertParameters>
                <asp:Parameter Name="PESS_COD" Type="Decimal" />
