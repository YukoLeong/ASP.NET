<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StudentAtribute.aspx.vb" Inherits="ep.StudentAtribute" %>
...
<body background="images/studentWork2.gif">
    ...
    <table class="style3">
        <tr>
            <td class="style4">
                <asp:Button ID="Button1" runat="server" Text="Student Attribute" 
                    CssClass="blue" />
            </td>
            <td>
                <asp:Button ID="Button2" runat="server" style="margin-left: 0px" 
                    Text="Seminar Attribute" CssClass="blue" />
            </td>
        </tr>
    </table>
    <br />
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        ...
        <span class="style1">Student Attribute</span>
     <br />
     <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:EPConnectionString4 %>" 
                ...
                SelectCommand="SELECT [experience_name], [professional], [leadership], [communication], [comprehension], [expression], [initiative], [self_enhancement], [civil_responsibility], [language], [it_application], [id] FROM [abilityMatrix] WHERE ([pess_cod] = @pess_cod) and experience_name&lt;&gt;@sem">
        <SelectParameters>
            <asp:SessionParameter Name="pess_cod" SessionField="pess_cod" Type="Decimal" />
            <asp:Parameter DefaultValue="Seminar_Conference" Name="sem" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
        ...
        <Fields>
            <asp:TemplateField HeaderText="Experience Name" 
                SortExpression="experience_name">
                <EditItemTemplate>
            ...
            <asp:CheckBoxField DataField="initiative" HeaderText="Initiative" 
                SortExpression="initiative" />
            <asp:CheckBoxField DataField="self_enhancement" HeaderText="Self Enhancement" 
                SortExpression="self_enhancement" />
            <asp:CheckBoxField DataField="civil_responsibility" 
        ...
        ConnectionString="<%$ ConnectionStrings:EPConnectionString4 %>" 
        SelectCommand="SELECT * FROM [seminarAttribute]"></asp:SqlDataSource>
        <span class="style1">Seminar Attribute</span>
        <br />
        <br />
