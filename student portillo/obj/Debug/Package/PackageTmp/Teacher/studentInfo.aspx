<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="studentInfo.aspx.vb" Inherits="ep.studentInfo" %>
...
<body background="../images/background.gif">
   ...
   <asp:LinkButton ID="LinkButton1" runat="server" CssClass="blue" 
     ...
     <br />
      ...
      <br />
      <br />
    <asp:Label ID="Label1" runat="server" Text="Subject Code:" Font-Bold="True" 
        Font-Size="Larger"></asp:Label>
        &nbsp;&nbsp;&nbsp;
         <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
         DataSourceID="SqlDataSource2" DataTextField="subjectCode" 
         DataValueField="subjectCode" AppendDataBoundItems="True">
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:EPConnectionString1 %>" SelectCommand="select teacherData.studentid,teacherData.studentname,Learning_Records_Correspond.Seminar_Conference,
...
from teacherData,Learning_Records_Correspond
where teacherData.pess_cod=Learning_Records_Correspond.pess_cod
and 
teacherData.subjectCode=@subjectCode
and 
teacherData.teacherCode=@teacherCode

">
         <SelectParameters>
             <asp:ControlParameter ControlID="DropDownList1" Name="subjectCode" 
                 PropertyName="SelectedValue" />
             <asp:SessionParameter Name="teacherCode" SessionField="teacherCode" />
         </SelectParameters>
        </asp:SqlDataSource>
           <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
               ...
               SelectCommand="SELECT distinct [subjectCode] FROM [teacherData] WHERE ([teacherCode] = @teacherCode)">
               <SelectParameters>
                   <asp:SessionParameter Name="teacherCode" SessionField="teacherCode" 
                       Type="String" />
               </SelectParameters>
