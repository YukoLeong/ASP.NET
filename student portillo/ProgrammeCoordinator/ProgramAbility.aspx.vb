...
Partial Class Student_ProgramAbility
    ...
    Protected Sub GridViewAbility_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridViewAbility.RowCommand
