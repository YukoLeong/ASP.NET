...
Partial Class Operator_SchoolSeminar
        ...
        If durationText.Text = "" And pointText.Text = "" Then
            Try
                ...
                Using mycon As New SqlConnection(con)
                    ...
                    Dim strSQL As String = "INSERT INTO [Seminar_Info] ([topicName], [category], [startDate], [duration], [organizer], [bonus_point], [status], [update_time],[topicNameCht],[categoryCht],[organizerCht],[uid],[COD]) VALUES (@topicName, @category, @startDate, NULL, @organizer, '-1', @status, GETDATE(), @topicNameCht, @categoryCht, @organizerCht, @uid, @COD)"
        ...
        ElseIf durationText.Text = "" Then
            Try
                ...
                Using mycon As New SqlConnection(con)
                    ...
                    Dim strSQL As String = "INSERT INTO [Seminar_Info] ([topicName], [category], [startDate], [duration], [organizer], [bonus_point], [status], [update_time],[topicNameCht],[categoryCht],[organizerCht],[uid],[COD]) VALUES (@topicName, @category, @startDate, '-1', @organizer, @bonus_point, @status, GETDATE(), @topicNameCht, @categoryCht, @organizerCht, @uid, @COD)"
