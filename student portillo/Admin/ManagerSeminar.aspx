<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManagerSeminar.aspx.vb" Inherits="Operator_ManagerSeminar" %>
...
<body background="../images/church.gif">
  <script type="text/javascript">
    ...
    <div>
        <span class="style8">Seminar/Activity Management</span> <%--        <asp:LinkButton ID="home" runat="server" CssClass="blue" 
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
                ...
                <tr>
                    <td class="style3">
                        <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Larger" 
                            Text="Seminar/Activity Year:"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style5">
                        <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Larger" 
                            Text="Seminar/Activity Category:"></asp:Label>
                    </td>
                    <td class="style6">
            ...
            <asp:Button ID="addSem" runat="server" CssClass="blue" Text="Add Seminar/Activity" />
            <br />
            <br />
    ...
    <asp:GridView ID="GridViewSeminar" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
           <asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Event Category" SortExpression="eventType">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("eventType") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label8" runat="server" Text='<%# Bind("eventType") %>'></asp:Label>
                </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SeminarInfo" runat="server" 
        ...
        SelectCommand="SELECT [id],[topicName], [category], [startDate], REPLACE (duration, '-1', '') as duration, [organizer], [bonus_point], [status], [update_time], [topicNameCht], [categoryCht], [organizerCht],[COD], [eventType] FROM [Seminar_Info] WHERE ((year([startDate]) = @startDate) AND ([category] = @category) AND ([status] = @status)) order by startDate desc"
        ...
        <UpdateParameters>
            ...
            <asp:SqlDataSource ID="categoryList" runat="server" 
                ConnectionString="<%$ ConnectionStrings:EPConnectionString %>" 
                SelectCommand="SELECT * FROM [SeminarCategory]"></asp:SqlDataSource>
        ...
        <asp:View ID="View2" runat="server">
            <table class="style9">
                <tr>
                    <td class="style11">
                        <asp:Label ID="semAct" runat="server" Text="Event Category:"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="style11">
                        <asp:Label ID="semDate" runat="server" Text="Seminar/Activity Year:"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="typeText" runat="server" DataSourceID="categoryList" 
                            DataTextField="sem_category" DataValueField="sem_category">
                        </asp:DropDownList>
                    </td>
                </tr>
                  <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="typeTextCht" runat="server" DataSourceID="categoryList" 
                            DataTextField="sem_categoryCht" DataValueField="sem_categoryCht">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <asp:TemplateField HeaderText="Category">
                        ...
                        <EditItemTemplate>
                            <asp:DropDownList ID="DropDownList1" runat="server" 
                                SelectedValue='<%# Bind("category") %>' DataSourceID="list1" 
                                DataTextField="sem_category" DataValueField="sem_category">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="list1" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:EPConnectionString %>" 
                                SelectCommand="SELECT * FROM [SeminarCategory]"></asp:SqlDataSource>
                        </EditItemTemplate>
                        <InsertItemTemplate>
                            <asp:DropDownList ID="DropDownList2" runat="server" 
                                SelectedValue='<%# Bind("category") %>' DataSourceID="list2" 
                                DataTextField="sem_category" DataValueField="sem_category">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="list2" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:EPConnectionString %>" 
                                SelectCommand="SELECT * FROM [SeminarCategory]"></asp:SqlDataSource>
                        </InsertItemTemplate>
                    </asp:TemplateField>
