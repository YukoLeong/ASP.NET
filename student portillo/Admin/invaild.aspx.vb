    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If (dv_time.Item(0).Item("active")) = False Then
                ...
                Exit Sub
            End If
            Label1.Text = Format(dv_time.Item(0).Item("startTimeEx"), "yyyy/MM/dd")
            Label2.Text = Format(dv_time.Item(0).Item("endTimeEx"), "yyyy/MM/dd")
            Label3.Text = Format(dv_time.Item(0).Item("startTimeEx"), "yyyy/MM/dd")
            Label4.Text = Format(dv_time.Item(0).Item("endTimeEx"), "yyyy/MM/dd")
