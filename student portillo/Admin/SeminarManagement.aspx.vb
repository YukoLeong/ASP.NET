...
Partial Class Operator_SeminarManagement
        ...
        If durationText.Text = "" And pointText.Text = "" Then
            Try
                ...
                Using mycon As New SqlConnection(con)
                    ...
                    Dim strSQL As String = "INSERT INTO [Seminar_Info] ([topicName], [category], [startDate], [duration], [organizer], [bonus_point], [status], [update_time],[topicNameCht],[categoryCht],[organizerCht],[uid],[COD]) VALUES (@topicName, @category, @startDate, NULL, @organizer, NULL, @status, GETDATE(), @topicNameCht, @categoryCht, @organizerCht, @uid, @COD)"

                    Using cmd As New SqlCommand()
                        cmd.Connection = mycon
                        cmd.CommandText = strSQL
                        cmd.Parameters.AddWithValue("@topicName", titleText.Text)
                        cmd.Parameters.AddWithValue("@category", typeText.Text)
                        ...
                        cmd.Parameters.AddWithValue("@categoryCht", typeTextCht.Text)
        ...
        ElseIf durationText.Text = "" Then
            Try
                ...
                Using mycon As New SqlConnection(con)
                    ...
                    Dim strSQL As String = "INSERT INTO [Seminar_Info] ([topicName], [category], [startDate], [duration], [organizer], [bonus_point], [status], [update_time],[topicNameCht],[categoryCht],[organizerCht],[uid],[COD]) VALUES (@topicName, @category, @startDate, NULL, @organizer, @bonus_point, @status, GETDATE(), @topicNameCht, @categoryCht, @organizerCht, @uid, @COD)"
        ...
        ElseIf pointText.Text = "" Then
            Try
                ...
                Using mycon As New SqlConnection(con)
                    ...
                    Dim strSQL As String = "INSERT INTO [Seminar_Info] ([topicName], [category], [startDate], [duration], [organizer], [bonus_point], [status], [update_time],[topicNameCht],[categoryCht],[organizerCht],[uid],[COD]) VALUES (@topicName, @category, @startDate, @duration, @organizer, NULL, @status, GETDATE(), @topicNameCht, @categoryCht, @organizerCht, @uid, @COD)"
        ...
        Else
            Try
                ...
                Using mycon As New SqlConnection(con)
                    ...
                    Dim strSQL As String = "INSERT INTO [Seminar_Info] ([topicName], [category], [startDate], [duration], [organizer], [bonus_point], [status], [update_time],[topicNameCht],[categoryCht],[organizerCht],[uid],[COD]) VALUES (@topicName, @category, @startDate, @duration, @organizer, @bonus_point, @status, GETDATE(), @topicNameCht, @categoryCht, @organizerCht, @uid, @COD)"
