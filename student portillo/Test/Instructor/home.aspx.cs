...
public partial class Student_home : System.Web.UI.Page
{
        ...
        if (Session["Role_Type"] == "coordinator" && Session["position"] == "tutor")
        {
            ...
            for (int i = 0; i < view2.Count; i++)
            {
                ...
                if (view2[i]["aiweb"].ToString() == "True")
                {
                    ...
                    Literal20.Text = @"<div class='monthebox'><a href='../aiwVerify.aspx' target='_blank'><div id='item48' class='icon'></div><div class='text'>Academic Information Web</div></a></div>";
    ...
    {
           Session.Clear();
           Response.Redirect("https://wire.ipm.edu.mo/cas/logout?url=http://172.25.2.163/ep/staff.aspx");
    }
