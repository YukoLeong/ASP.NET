...
<div id="wrapper">
	...
	<div id="headerStaff">
	 ...
	 style="margin-top: 43px;margin-left: 4px;"  OnClick="ImageButton1_Click" />
         <div id="lang-panel">
                    ...
                    <br />
                    <%--<asp:Label ID="Label1" runat="server" Text="<%$ Resources:Resource, ep_welcome %>" />--%>                   
                </div>
	</div>
	...
	<div id="menu">
		<ul>
			...
			<li><a href="#"></a></li>
			<li><a href="#"></a></li>
            <li><asp:LinkButton ID="LogOut" runat="server" onclick="LogOut_Click" Text="<%$ Resources:Resource, sip_signout %>"></asp:LinkButton></li>
		</ul>
...
<!--
	...
	-->
       ...
       <div id='seticon'>
        ...
        <asp:Literal ID="Literal218" runat="server"></asp:Literal>
		...
		<div>
		 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
		    ...
		    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ConnectionString="<%$ ConnectionStrings:EPConnectionString %>" SelectCommand="SELECT * FROM [userGroup] WHERE ([id] = @id) union 
SELECT * FROM [userGroup] WHERE ([id] = @cd)">
                <SelectParameters>
                    <asp:SessionParameter Name="id" SessionField="Role_Type" Type="String" />
                    <asp:SessionParameter Name="cd" SessionField="position_role" Type="String"/>
                </SelectParameters>
            </asp:SqlDataSource>
		</div>
	</div>
