<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProgramSubjects.aspx.cs" Inherits="ProgrammeCoordinator_ProgramSubjects" %>
...
<body background="../images/bg-blue.jpg">
    ...
    <br />
    <br />
    <asp:Label ID="txt_title" runat="server" Text="<%$ Resources:Resource, sip_program_subject %>"  style="color:black;font-size:xx-large;font-family: 'Berlin Sans FB';"/>
...
<div style="text-align:center;margin-top:-32px;padding-bottom:12px;width:1057px">
    ...
    <table cellspacing="1" cellpadding="2" width="100%" style="border:solid #CCC 1px;border-radius:5px;">
        <tr>
        ...
        <tr>
            <td colspan="4"> <span style="color:blue;">
                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:Resource, sip_pls_select %>"></asp:Label>  "<span style="color:red;"><asp:Label ID="Label17" runat="server" Text="<%$ Resources:Resource, sip_program %>"></asp:Label></span>",
                 "<span style="color:red;"><asp:Label ID="Label10" runat="server" Text="<%$ Resources:Resource, sip_acad_year %>"></asp:Label></span>" <asp:Label ID="Label15" runat="server" Text="<%$ Resources:Resource, sip_and %>"></asp:Label> 
                "<span style="color:red;"><asp:Label ID="Label11" runat="server" Text="<%$ Resources:Resource, sip_subject_code %>"></asp:Label></span>", <asp:Label ID="Label24" runat="server" Text="<%$ Resources:Resource, sip_then %>"></asp:Label> "<span style="color:red;"><asp:Label ID="Label25" runat="server" Text="<%$ Resources:Resource, sip_search %>"></asp:Label></span>" 
                <asp:Label ID="Label26" runat="server" Text="<%$ Resources:Resource, sip_button %>"></asp:Label>.</span>
       ...
       <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Resource, sip_school %>"></asp:Label>: 
                </td>
                <td colspan="4">
               <%--     <asp:ListBox ID="programList" runat="server" OnSelectedIndexChanged="programList_SelectedIndexChanged"
                        ...
                        <asp:TextBox ID="txt_school" runat="server"  Width="545px" Enabled="false">
                            </asp:TextBox>
             ...
             <tr>
                <td>
                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:Resource, sip_program %>"></asp:Label>: <span style="color:red;">*</span>
                </td>
                <td colspan="5">
                 <%--  <asp:TextBox ID="txt_program" runat="server" Enabled="false" Width="545px"/>--%>
                    <asp:ListBox ID="programList" runat="server" Height="50px" Width="720" AutoPostBack="true" 
                    OnSelectedIndexChanged="cursoList_SelectedIndexChanged">
                    </asp:ListBox>
               

                  <%--  <asp:ListBox ID="cursoList" runat="server" OnSelectedIndexChanged="cursoList_SelectedIndexChanged"
                        AutoPostBack="true" Style="width: 550px; height: 98px;"></asp:ListBox>--%>
                </td>
            </tr>
			<tr>       	
            ...
            <td>
                <asp:DropDownList ID="yearList" runat="server" Width="250"
                ...
                <tr>
                    <td style="width:120px;"><asp:Label ID="Label12" runat="server" Text="<%$ Resources:Resource, sip_subject_code %>"></asp:Label>: <span style="color: red;">*</span>
                    </td>
                    <td>
                        <asp:ListBox ID="subjectCodeList" runat="server" Height="70px" Width="250px" onselectedindexchanged="subjectCodeList_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                    </td>
               
           
            <td>
                <asp:RequiredFieldValidator ID="reqsubjectCodeList" ControlToValidate="subjectCodeList" ErrorMessage="<%$ Resources:Resource, sip_subject_code_req %>"
                        runat="server" style="color:Red;"  /></td>
        </tr>
        <tr>
           <td><asp:Label ID="Label14" runat="server" Text="<%$ Resources:Resource, sip_subject %>"></asp:Label>:
           </td>
           <td colspan="5"><asp:TextBox ID="txt_subjectName" runat="server" Enabled="false" style="width:650px;" ></asp:TextBox></td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:Resource, sip_class_name %>"></asp:Label>:</td>
            <td> <asp:DropDownList ID="classNameList" runat="server"  Width="250px">
                <asp:ListItem Value="" Text="<%$ Resources:Resource, sip_pls_select2 %>"></asp:ListItem>
                 </asp:DropDownList></td>
        </tr>
          ...
          <tr>
            <td></td>
            <td><asp:ImageButton ID="btn_search" runat="server" Text="Search" onmouseover="this.src='../images/search2.png'" 
			onmouseout="this.src='../images/search1.png'" ImageUrl="../images/search1.png" OnClick="btn_search_Click" style="width: 100px"/>
        ...
        <tr style="display:none;">
            <td class="style12">
                &nbsp;</td>
            <td class="style5">
                <asp:ListBox ID="ListBox3" runat="server" Height="250px" Width="250px"
                Visible="False">
                </asp:ListBox>
            </td>
    ...
    <div>
        ...
        <asp:ImageButton ID="viewButton" runat="server" Text="Details" onmouseover="this.src='../images/detail2.png'" 
    ...
    <br />
	 <asp:Panel ID="dataPanel" runat="server" Visible="false">
        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:Resource, sip_hint %>"></asp:Label>
          <br /> <br />
              ...
              <tr>
                <td>
                    <table style="border: black 1px; border-radius: 5px; background-color: Wheat; text-align: center; margin-left: 28%; ">
                        <tr>
                            <td>
                                <asp:Label ID="Label32" runat="server" Text="<%$ Resources:Resource, sip_desc_stats %>"></asp:Label></td>
                            <td>
                                <table>
                                    <tr>
                                        <td><asp:Label ID="Label33" runat="server" Text="<%$ Resources:Resource, sip_lowest %>"></asp:Label></td>
                                        <td>Q1(25%)</td>
                                        <td><asp:Label ID="Label34" runat="server" Text="<%$ Resources:Resource, sip_med %>"></asp:Label></td>
                                        <td>Q3(75%)</td>
                    ...
                    <table style="border: black 1px; border-radius: 5px; background-color: Wheat; text-align: center; margin-left: 28%;">
                        <tr>
                            ...
                            <td>
                                <table style="border: black 1px;">
                                    <tr>
                                        <td><asp:Label ID="Label37" runat="server" Text="<%$ Resources:Resource, sip_lowest %>"></asp:Label></td>
                                        <td>Q1(25%)</td>
                                        <td><asp:Label ID="Label38" runat="server" Text="<%$ Resources:Resource, sip_med %>"></asp:Label></td>
                                        <td>Q3(75%)</td>
                                        <td><asp:Label ID="Label39" runat="server" Text="<%$ Resources:Resource, sip_highest %>"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
