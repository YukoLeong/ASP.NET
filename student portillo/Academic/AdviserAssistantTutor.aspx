<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdviserAssistantTutor.aspx.cs" Inherits="Instructor_AdviserAssistantTutor" %>
...
<body background="../images/bg-blue.jpg">
    ...
    <div id="content">
	  ...
	  <label style="color:black;font-size:xx-large;font-family: 'Berlin Sans FB';"><asp:Label ID="lb_title" runat="server" Text="<%$ Resources:Resource, sip_aa_title%>"></asp:Label></label>
    ...
    <tr >
    <td align="right"><asp:Label ID="lb_filter" runat="server" Text="<%$ Resources:Resource, sip_aa_filter%>"></asp:Label>
    </td>
    <td align="left">
...
<td style="text-align:right;"><asp:Label ID="lb_tto" runat="server" Text="<%$ Resources:Resource, sip_aa_to%>"></asp:Label></td>
    ...
    <td>
     ...
     <tr>
     <td align="right"><asp:Label ID="Label7" runat="server" Text="<%$ Resources:Resource, sip_aa_ty%>"></asp:Label></td>
    <td>
        ...
        <tr>
             ...
             <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Resource, sip_aa_sub%>"></asp:Label>
              
                </td>
            <td colspan="4">
                <asp:DropDownList ID="subjectCodeList" runat="server"  Width="600px" 
     ...
     <tr>
    <td align="right"><asp:Label ID="Label9" runat="server" Text="<%$ Resources:Resource, sip_aa_ay%>"></asp:Label><span style="color:red;">*</span>
          </td>
          <td>
        <asp:DropDownList ID="yearListBox" runat="server" 
         ...
         <asp:RequiredFieldValidator ID="req_message" ControlToValidate="yearListBox" ErrorMessage="<%$ Resources:Resource, sip_acad_year_req %>"
		...
		<table>
         <tr> 
				...
				&nbsp;<asp:Label ID="lb_ps" runat="server" Text="<%$ Resources:Resource, sip_aa_ps%>"></asp:Label>
                                                            &quot;
				<span style="color:Red;"><asp:Label ID="lbsubject" runat="server" Text="<%$ Resources:Resource, sip_aa_sj%>"></asp:Label></span> 
		 ...
		 <td><div id="func_panel" style="display:none;">
            ...
            <table id="example" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Resource, sip_advice_std_id %>"></asp:Label>
                        </th>
                        <th style="width:200px;">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Resource, sip_std_name %>"></asp:Label>
                        </th>
                        <th>
                            GPA
                        </th>
                        <th>
                            <asp:Label ID="Label222" runat="server" Text="<%$ Resources:Resource, sip_aa_fail %>"></asp:Label>
                        </th>
