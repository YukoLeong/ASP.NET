...
<body background="../images/bg-blue.jpg">
    ...
    <div id="content">
        <br />
        <br />
        <asp:Label ID="txt_title" runat="server" Text="Instructor Subjects" style="color:Blue;font-size:14pt;"/>
        <br />
        <br />
       ...
       <asp:Panel ID="linePanel" runat="server" Visible="false">
        ...
        <td>
        <hr />
           <asp:label ID="Label1" runat="server" Text="Course Work" style="color:blue;"> </asp:label>
           </td>
         ...
         <td>
            ...
            <tr>
             <td>
             <hr />
               <asp:Label ID="Label2" runat="server" style="color:blue;" Text="Final Exam"> </asp:Label>
            </td>
            </tr>
             <tr>
            <td>
          ...
          <tr>
            <td>
            <hr />
              <asp:label ID="Label3" runat="server" Text="Final Score" style="color:blue;"> </asp:label>
            </td>
...
<tr>
           ...
           <asp:Label ID="Label5" runat="server" text="Final Score Pass Ratio:" 
           style="color:Blue; font-family: 'Times New Roman', Times, serif;font-size:13pt;"/>
           <br />
