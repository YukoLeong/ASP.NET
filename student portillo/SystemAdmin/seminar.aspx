<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="seminar.aspx.vb" Inherits="ep.seminar" %>
...
<body background="images/background.gif">
    ...
    <div>
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" 
                         DataSourceID="SqlDataSource2" DataTextField="programme_name" 
                         DataValueField="programme_name" Height="22px" Width="100px">
        ...
        <asp:TemplateField   
            ...
            <ItemTemplate>  
                <asp:CheckBox   
                    ID="chk1"   
                    runat="server"   
                    Text='<%#DataBinder.Eval(Container.DataItem,"studentid") & " " & DataBinder.Eval(Container.DataItem,"studentname") %>' />  
            </ItemTemplate>  
...
<asp:HiddenField ID="hiddenCatIDs" runat="server" />  
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                         ...
                         SelectCommand="SELECT distinct [programme_name] FROM [directorData] WHERE ([department_name] = @department_name)">
                         <SelectParameters>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
    ...
    <HeaderStyle HorizontalAlign="Center" BackColor="#0095CD" Font-Bold="True" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                         ConnectionString="<%$ ConnectionStrings:EPConnectionString1 %>" 
                          SelectCommand="SELECT [studentid], [studentname] FROM [directorStud] WHERE (([department_name] = @department_name) AND ([programme_name] = @programme_name))">
                         <SelectParameters>
                             <asp:ControlParameter ControlID="DropDownList1" Name="department_name" 
                                 PropertyName="SelectedValue" Type="String" />
                             <asp:ControlParameter ControlID="DropDownList2" Name="programme_name" 
                                 PropertyName="SelectedValue" Type="String" />
                         </SelectParameters>
                     </asp:SqlDataSource>
