...
public partial class Student_home : System.Web.UI.Page
{
    ...
    { 
        ...
        {
            Literal1.Text = @"<div class='monthebox'><a href='../Teacher/AdvisoryRemark.aspx'><div id='item12' class='icon'></div><div class='text'>Instructor Advices</div></a></div>";
        ...
        if (view[0]["uam"].ToString() == "True")
        {
            ...
            Literal14.Text = @"<div class='monthebox'><a href='../SystemAdmin/RoleAccount.aspx'><div id='item42' class='icon'></div><div class='text'>User Account Management</div></a></div>";
        ...
        if (view[0]["ugm"].ToString() == "True")
        {
            ...
            Literal15.Text = @"<div class='monthebox'><a href='../SystemAdmin/userGroup.aspx'><div id='item43' class='icon'></div><div class='text'>User Group Management</div></a></div>";
        ...
        if (view[0]["lram"].ToString() == "True")
        {

            Literal18.Text = @"<div class='monthebox'><a href='../SystemAdmin/LearningRecordManagement.aspx'><div id='item7' class='icon'></div><div class='text'>Learning Record Management</div></a></div>";
         ...
         if (view[0]["ds"].ToString() == "True")
        {
         ...
         if (view[0]["mc"].ToString() == "True")
        {

           Literal20.Text = @"<div class='monthebox'><a href='../SystemAdmin/ManageComments.aspx'><div id='item58' class='icon'></div><div class='text'>Manage Comments</div></a></div>";
