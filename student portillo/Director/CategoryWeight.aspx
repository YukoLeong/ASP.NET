...
<body>
    ...
    <p>
        <asp:GridView ID="GridViewCategory" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
            ...
            EnablePersistedSelection="True" GridLines="Horizontal" ShowHeaderWhenEmpty="True" 
            Font-Names="Calibri" Font-Size="Small" 
            
            style="z-index: 1; left: 15px; top: 75px;  " Width="574px" Height="182px" 
            CssClass="GridViewStyle" PageSize="9">
            <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
            <Columns>
                <asp:CommandField ShowSelectButton="True" SelectText="View" >
                <ItemStyle ForeColor="#0095CD" />
                </asp:CommandField>
                <asp:BoundField DataField="programme" HeaderText="Program" ReadOnly="True" 
                ...
                <asp:BoundField DataField="Social_Responsibility" 
                    HeaderText="Social Responsibility" 
        ...
        SelectCommand="SELECT * FROM [CategoryWeight] WHERE ([school] = @school) ORDER BY [programme]">
            <SelectParameters>
    ...
    <asp:DetailsView ID="DetailsViewCategory" runat="server" AllowPaging="True" 
        ...
        <Fields>
            ...
            <asp:BoundField DataField="Self_Development" HeaderText="Self Development" 
                SortExpression="Self_Development" />
            <asp:BoundField DataField="Social_Responsibility" HeaderText="Social Responsibility" 
                SortExpression="Social_Responsibility" />
