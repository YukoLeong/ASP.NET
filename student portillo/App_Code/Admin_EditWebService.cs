...
/// <summary>
/// Summary description for Admin_EditWebService
/// </summary>
...
public class Admin_EditWebService : System.Web.Services.WebService {
    ...
    public void SyncData(string data, string careerformid)
    {
        if (data != "" && careerformid != "")
        {
            ...
            sb.Append("UPDATE CareerForm SET checked=@data where CareerFormID=@CareerFormID");
