...
/// <summary>
/// Summary description for FinalAdmin_EditWebService
/// </summary>
...
public class FinalAdmin_EditWebService : System.Web.Services.WebService {
    ...
    public void SyncData(string data, string careerformid)
    {
        if (data != "" && careerformid != "")
        {
            ...
            if (data == "1")
            {
                ...
                cmd.Parameters.AddWithValue("@CareerFormID", careerformid);
                cmd.ExecuteNonQuery();
            }
            else
            {
                sb.Append("UPDATE CareerForm SET canpost=@data,permitdate=null where CareerFormID=@CareerFormID");
                SqlCommand cmd = new SqlCommand(sb.ToString(), con);
                cmd.Parameters.AddWithValue("@data", data);
                //cmd.Parameters.AddWithValue("@CareerFormID", 114);
    ...
    //public void SyncData2(string data, string careerformid)
    //{
    //    if (data != "" && careerformid != "")
    //    {
    //        con.Open();
