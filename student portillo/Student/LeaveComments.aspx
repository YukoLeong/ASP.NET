<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaveComments.aspx.cs" Inherits="Student_LeaveComments" %>
...
<body background="../images/bg-blue.jpg">
 <form id="form1" runat="server"> 
    ...
    <div id="content"> 
         ...
         <asp:Label runat=server style="color:black;font-size:xx-large;font-family: 'Berlin Sans FB';" Text="<%$ Resources:Resource, sip_lc_message %>"></asp:Label>
              <br />  
			  <div align="center">
                                                              ...
                                                              <td height="23" colspan="2">
                                                                  <table border="0" width="100%" cellspacing="1" cellpadding="8" bgcolor="#cccccc">
                                                                     ...
                                                                     <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
                                                                       <tr>
                                                                              <td>
                                                                                  <img src="images/regb.gif" width="18" height="18" />
