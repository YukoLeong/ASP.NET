...
Public Class Career
    ...
    Private Sub changeCareer()
        ...
        If DropDownCareer.SelectedIndex >= 0 And chkCareer.Checked = True Then
            ...
            SqlDataSource7.SelectCommand = "SELECT * FROM CareerAttribute2 where career='" & DropDownCareer.SelectedItem.Text & "'"
