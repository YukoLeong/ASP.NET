<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CurriculumVitaeAct.aspx.vb" Inherits="Student_CurriculumVitaeAct" %>
  ...
  <div id="main-nav-wrapper">
    ...
    <table class="style1">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Student\ActCV.rdlc">
                <DataSources>
