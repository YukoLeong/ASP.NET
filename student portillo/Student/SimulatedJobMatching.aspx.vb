...
Partial Class Student_SimulatedJobMatching
    Inherits System.Web.UI.Page

    Private Sub SimulatedJobMatching_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If dv_verify.Item(0).Item("sjm") = "False" Then
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LinkButton1.Click
          If Session("Position") = "student" Then
            Response.Redirect("home.aspx")
        End If

        If Session("Position") = "teacher" Then
            Session("Role_Type") = "teacher"
            Response.Redirect("schoolStaff.aspx")
        End If

        If Session("Position") = "tutor" Then
            Session("Role_Type") = "tutor"
            Response.Redirect("schoolStaff.aspx")
        End If

        If Session("Position") = "coordinator" Then
            Session("Role_Type") = "coordinator"
            Response.Redirect("schoolStaff.aspx")
        End If
      
        If Session("Position") = "director" Then
            Session("Role_Type") = "director"
            Response.Redirect("schoolStaff.aspx")
        End If
    End Sub
End Class
