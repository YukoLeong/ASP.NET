...
Imports System.Data
Partial Class Student_CurriculumVitaeActCht
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Dim a As String = dv_school.Item(0).Item("school_ch")
            Dim b As String = dv_program.Item(0).Item("PROGRAM_CH")
    ...
    Protected Sub ImageButtonapic1_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles ImageButtonapic1.Click

        Response.Redirect("CurriculumVitaeAct.aspx")
        ImageButtonapic1.CssClass = "aimgactive"
        ImageButtonapic2.CssClass = "aimg"
    End Sub

    Protected Sub ImageButtonapic2_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles ImageButtonapic2.Click

        Response.Redirect("CurriculumVitaeActCht.aspx")
        ImageButtonapic1.CssClass = "aimg"
        ImageButtonapic2.CssClass = "aimgactive"
    End Sub


    Protected Sub ImageButtonapic8_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles ImageButtonapic8.Click
        If Session("Role_Type") = "student" Then
            Response.Redirect("home.aspx")
        End If
