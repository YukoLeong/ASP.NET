<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditComments.aspx.cs" ClientTarget="uplevel" Inherits="Student_EditComments" %>
     ...
     <p style="color:black;font-size:18pt;font-family:comic sans ms,sans-serif;">Instructor Remark</p>
        <table>
            <tr>
                ...
                <td>
                <asp:TextBox ID="txt_StdID" runat="server" Width="222px" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                <asp:TextBox ID="txt_StdName" runat="server" Width="222px" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
