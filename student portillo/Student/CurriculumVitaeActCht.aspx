<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CurriculumVitaeActCht.aspx.vb" Inherits="Student_CurriculumVitaeActCht" %>
...
<%--       <asp:LinkButton ID="LinkButton1" runat="server" CssClass="blue" 
  ...
  <div id="main-nav-wrapper">
             <nav class="main-nav">
                <ul class="main-nav-list">
                    ...
                    <li class="apic1color">
                        ...
                        <asp:ImageButton ID="ImageButtonapic1" runat="server" ImageUrl="~/Student/animatedmenu3/fpic1.png" CssClass="aimg" />
                    </li>

                    <li class="apic2color">
                        <asp:ImageButton ID="ImageButtonapic2" runat="server" ImageUrl="~/Student/animatedmenu3/fpic2.png" CssClass="aimgactive" />
                    </li>
    ...
    <asp:SqlDataSource ID="SqlDataSource18" runat="server" 
        ...
        SelectCommand="SELECT [SCHOOL_CH] FROM [student_academic_info] WHERE ([ALUN_NUMERO] = @ALUN_NUMERO AND [ALUN_NUMERO_SEQ] = @ALUN_NUMERO_SEQ)">
            <SelectParameters>
        ...
        SelectCommand="SELECT [PROGRAM_CH] FROM [student_academic_info] WHERE ([ALUN_NUMERO] = @ALUN_NUMERO AND [ALUN_NUMERO_SEQ] = @ALUN_NUMERO_SEQ)">
            <SelectParameters>
                  <asp:SessionParameter Name="ALUN_NUMERO" SessionField="ALUN_NUMERO" Type="String" />
                  <asp:SessionParameter Name="ALUN_NUMERO_SEQ" SessionField="ALUN_NUMERO_SEQ" Type="Decimal" />
            </SelectParameters>
    ...
    <table class="style1">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Student\ActCV(cht).rdlc">
                <DataSources>
