        ...
        If ind > 0 Then
            ...
            If tmp_id.Length > 0 Then
                ...
                Try
                    ...
                    Dim cmd2 As SqlCommand = New SqlCommand("Select * from student_academic_info where netid=@id", conn)
                    ...
                    If tmp_ds1.Tables("student_academic_info").Rows.Count <> 0 Then
                        ...
                        Response.Write(Session("Role_Type"))
                        Response.Redirect("http://172.26.122.66/siw/login.asp")
